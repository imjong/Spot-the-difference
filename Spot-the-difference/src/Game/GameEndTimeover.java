...
public class GameEndTimeover extends JFrame {
	EventHandler event;
	
	JPanel pnBase = new JPanel(); //pnBase
	SizePanel pnBackGround = new SizePanel(new ImageIcon("./images/result/timeover.gif"), 900, 900);// pnBackGround 이미지 경로와 width, height 설정
	...
	public GameEndTimeover() {
		...
		tfScore.setForeground(new Color(0xbf, 0xff, 0x00));// tfScore의 폰트색상 설정
		...
		pnBackGroundSouth.add(btBack); // pnBackGroundSouth 투명하게 설정
		pnBackGroundSouth.setOpaque(false); // pnBackGroundSouth에 btBack 부착
